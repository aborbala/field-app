...
**In Antigravity:** Use `view_file` to load a skill. Search in priority order:
1. `.agent/skills/<skill-name>/SKILL.md`
2. `~/.gemini/skills/<skill-name>/SKILL.md`

When you load a skill, follow it directly.

**In Claude Code:** Skills are loaded via the `Skill` tool. Claude Code searches:
1. `.claude/skills/<skill-name>/SKILL.md`
2. `.agent/skills/<skill-name>/SKILL.md`
